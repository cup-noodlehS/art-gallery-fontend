                ...
                {showSearch && !collapseLinks && (
                    <label className="input input-bordered mx-5 grow flex items-center gap-2 rounded-sm">
                        <input
                            ...
                            onKeyDown={(e) =>
                                e.key === 'Enter' &&
                                router.push(`/artworks?search=${searchKey}`)
                            }
                            type="text"
                            className="grow"
                        ...
                        {navRoutes.map(
                            (route, index) =>
                                (!route.isLoggedIn ||
                                    ...
                                    >
                                        <button
                                            className={`font-medium ${pathname === route.route ? 'text-black' : 'text-gray-500'}`}
                                        >
                                        ...
                                        <div
                                            className={`h-0.5 w-full ${pathname === route.route ? 'bg-black' : 'bg-transparent'}`}
                                        ></div>
                                    </div>
                                )
                        )}
