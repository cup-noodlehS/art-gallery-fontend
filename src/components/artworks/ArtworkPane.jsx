      ...
      <div className="flex gap-5 min-h-lvh">
        ...
        >
          <div className="max-w-[240px] min-w-[240px] px-3 bg-black/[.02] border-r border-black/[.1]">
            <h3 className="text-2xl font-semibold mt-5 mb-2">Top Categories</h3>
            <input
              onChange={(e) => {
              ...
              className="input rounded-sm input-bordered w-full max-w-xs"
            />
              ...
              {categories.map((category) => (
                <div className="flex gap-3 items-center" key={category.id}>
                  ...
                  <label
                    ...
                    for={category.id}
                  >
                    <h4 className="text-md tracking-widest max-w-[120px] truncate">
                      {category.name}
                    </h4>
                    <div className="badge">
          ...
          <div className="flex justify-center mt-5">
            {pageCount > 1 && (
              <div className="join">
                ...
                {Math.ceil(currentPage / ARTWORK_SIZE_PER_REQUEST) !==
                  pageCount && (
                  <button
                    onClick={() => {
                      setTop(top + ARTWORK_SIZE_PER_REQUEST);
