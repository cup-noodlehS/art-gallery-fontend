...
const SingleArtworkPage = ({ params }) => {
  ...
  const price = parseFloat(
    artwork?.current_highest_bid || artwork?.starting_bid || 0
  );
  ...
  const handleImageClick = (index) => {
    const selectedImageUrl =
      artwork.images[index]?.image_url || defaultAvatarUrl;
    ...
    <div className="overflow-x-hidden">
                      ...
                      {isArtworkArtist && (
                        <div className="flex flex-col gap-2 items-start w-max">
                          {artwork.status === 0 ? (
                            <button
                              onClick={() =>
                                router.push(`/artworks/${artwork.slug}/edit`)
                              }
            ...
            <div>
              ...
              <div className="flex justify-between items-center mt-5 px-5 py-3 border border-gray-300 rounded-md">
                <div className="flex gap-3 items-center">
                  <Image
                    onClick={() => {
                      router.push(`/user/${artwork.artist.id}`);
                    }}
                    src={artwork.artist.avatar_url || defaultAvatarUrl}
                    width={40}
                    height={40}
                    alt="pfp"
                ...
                <div className="flex gap-3 items-center">
                  <a
                    href={`mailto:${artwork.artist.email}`}
                  ...
                  <button className="btn rounded-full">Folow</button>
                </div>
              </div>
            </div>
            ...
            <div className="w-[300px] flex flex-col justify-between grow border-2 border-solid px-10 py-7 font-Adamina rounded-md">
              <div>
                <div className="flex flex-col gap-3">
                  ...
                  <h1 className="font-bold text-xl py-3 px-4 bg-gray-100">
                    {artwork.current_highest_bid ? 'Highest' : 'Starting'} Bid:
                    ₱ {price}
                  </h1>
                  ...
                  {artwork?.category && (
                    <div className="flex gap-2 items-center h-[25px]">
                      ...
                      <h1 className="text-gray-600 text-md capitalize">
      ...
      {showBidsModal && (
        <BidsModal
          ...
          artwork={artwork}
          setShowAddBidModal={setShowAddBidModal}
        />
      )}
      {showAddBidModal && (
        <AddBidModal
